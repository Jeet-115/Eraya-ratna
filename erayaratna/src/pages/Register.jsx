    ...
    <section className="min-h-screen w-full bg-gradient-to-br from-[#FFF6F0] to-[#EAF2F8] flex items-center justify-center px-4 py-10 text-[#4B2E2E] outfit relative overflow-hidden">
      ...
      >
        ...
        <motion.p
          ...
          transition={{ delay: 0.3 }}
        >
          Join <span className="font-semibold">Eraya RATNA</span> and discover the divine within you 💫
        </motion.p>
        ...
        >
          “As you take your first step with us, may you walk the path of light, peace, and prosperity.” 🧘‍♀️
        </motion.p>
      </motion.div>
    </section>
  );
